...
describe("docs contract", () => {
  it("keeps the public reviewer command surface and deterministic verification entry points documented", async () => {
    ...
    expect(readme).toContain("cam mcp doctor --host codex");
    ...
    expect(readme).toContain("rollbackSucceeded");
    expect(readme).toContain("effectiveAction");
    ...
    expect(readmeTw).toContain("cam mcp doctor --host codex");
    ...
    expect(readmeTw).toContain("rollbackSucceeded");
    expect(readmeTw).toContain("effectiveAction");
    ...
    expect(readmeJa).toContain("cam mcp doctor --host codex");
    ...
    expect(readmeJa).toContain("rollbackSucceeded");
    expect(readmeJa).toContain("effectiveAction");
    ...
    expect(readmeEn).toContain("cam mcp doctor --host codex");
    ...
    expect(readmeEn).toContain("rollbackSucceeded");
    expect(readmeEn).toContain("effectiveAction");
