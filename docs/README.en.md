...
| Document | Purpose | Language availability |
| :-- | :-- | :-- |
| [architecture](./architecture.en.md) | current architecture, runtime path, and storage boundaries | English / [中文](./architecture.md) |
