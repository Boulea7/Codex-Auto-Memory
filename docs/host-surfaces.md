...
- **Codex 是当前主宿主**
- Gemini / OpenCode / OpenClaw 是重要参考宿主
- 当前仓库不直接改写成多宿主统一平台
...
- 对非 Codex 宿主，当前仓库只承接 manual-only / snippet-first 接入，不把更强的 host-native surface 误写成本仓已经自动接管的能力
...
- Gemini 当前属于“公开能力值得研究，但本仓只支持 manual-only wiring guidance”的范围
