...
9. Inspect `src/lib/domain/memory-sync-audit.ts`
10. Inspect `src/lib/domain/sync-service.ts`
11. Inspect `src/lib/domain/memory-store.ts`
12. Inspect `src/lib/domain/session-continuity-store.ts`
13. Inspect extractor files
14. Run `pnpm test`
15. Read `docs/claudecode-patch-audit.md`
16. Read `docs/reviewer-handoff.md`
